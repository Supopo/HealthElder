...
public class LiveMsgActivity extends BaseActivity<ActivityInteractiveBinding, InteractiveViewModel> {
    ...
    private String messageGroup = com.xaqinren.healthyelders.moduleMsg.Constant.LIVE;
    ...
    public void initViewObservable() {
        ...
        viewModel.requestSuccess.observe(this,boo ->{
            dismissDialog();
        });
