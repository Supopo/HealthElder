...
public class MallMenu1Adapter extends BaseQuickAdapter<MenuBean, BaseViewHolder> implements LoadMoreModule {
    public MallMenu1Adapter(int layoutResId) {
        super(layoutResId);
    }
    ...
    protected void convert(BaseViewHolder helper, MenuBean item) {
        ...
        ItemMallMenu1Binding binding = DataBindingUtil.bind(helper.itemView);
