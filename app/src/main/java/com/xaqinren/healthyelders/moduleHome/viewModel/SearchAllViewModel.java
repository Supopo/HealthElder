    ...
    public void searchDatas(int page, int searchType) {
        switch (searchType) {
            case 0:
                ...
                LiveRepository.getInstance().getHomeVideoList(null, page, 10, 0, allDatas, resType, tags);
                break;
            case 1:
                //视频
                LiveRepository.getInstance().getHomeVideoList(null, page, 10, 0, videoDatas, Constant.REQ_TAG_SP, tags);
                break;
            case 2:
                //用户
                LiveRepository.getInstance().getHomeVideoList(null, page, 10, 0, userDatas, Constant.REQ_TAG_YH, tags);
                break;
            case 3:
                //商品
                LiveRepository.getInstance().getHomeVideoList(null, page, 10, 0, goodsDatas, Constant.REQ_TAG_GOODS, tags);
                break;
            case 4:
                //直播
                LiveRepository.getInstance().getHomeVideoList(null, page, 10, 0, zbDatas, Constant.REQ_TAG_ZB, tags);
                break;
            case 5:
                //图文
                LiveRepository.getInstance().getHomeVideoList(null, page, 10, 0, twDatas, Constant.REQ_TAG_TW, tags);
                break;
        }
    }
}
