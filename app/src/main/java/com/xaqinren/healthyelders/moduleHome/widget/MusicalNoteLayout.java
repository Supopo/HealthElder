package com.xaqinren.healthyelders.moduleHome.widget;
...
public class MusicalNoteLayout extends RelativeLayout implements WeakWrapperHandler.MessageHandler {
    ...
    private static final int DEFAULT_MUSIC_VIEW_SIZE = 45;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultSize = dip2px(getContext(), DEFAULT_MUSIC_VIEW_SIZE);
        int musicViewSize;
        ...
        params.bottomMargin = dip2px(getContext(), 25);
        addView(mMusicView, params);
        Drawable note1 = getResources().getDrawable(R.mipmap.ic_music_note1);
        Drawable note2 = getResources().getDrawable(R.mipmap.ic_music_note2);
    ...
    public void handleMessage(Message msg) {
        ...
        if (msg.what == MSG_WHAT_ROTATION) {
            ...
            mAnimateHandler.sendEmptyMessageDelayed(MSG_WHAT_ROTATION, DEFAULT_ROTATION_SPEED);
            ...
            addMusicNote(mIndex);
            mAnimateHandler.sendEmptyMessageDelayed(MSG_WHAT_ADD_NOTE, DEFAULT_ADD_NOTE_SPEED);
        }
    ...
    private ValueAnimator getBezierValueAnimator(View target) {
        ...
        BezierEvaluator evaluator = new BezierEvaluator(new PointF(0f, mHeight - mHeight / 4), new PointF(0f, mHeight - mHeight / 2));
        ValueAnimator animator = ValueAnimator.ofObject(evaluator,
                new PointF(mMusicView.getX() + mMusicView.getWidth() / 2 - mDrawableHeight / 2, mMusicView.getBottom()),
