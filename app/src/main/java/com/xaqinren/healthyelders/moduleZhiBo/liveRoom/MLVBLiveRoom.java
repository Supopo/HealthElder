...
public abstract class MLVBLiveRoom {
    ...
    public abstract void createRoom(final String pushUrl, final String roomID, final String roomInfo, final IMLVBLiveRoomListener.CreateRoomCallback callback);
     ...
     */
    public abstract void joinAnchor(int type, final IMLVBLiveRoomListener.JoinAnchorCallback callback);
     ...
     */
    public abstract void quitJoinAnchor(int type, final IMLVBLiveRoomListener.QuitAnchorCallback callback);
    ...
    //开启纯语音推流
    public abstract void startLocalPreview(TXCloudVideoView view);
    ...
    public abstract void sendRoomCustomMsg(String cmd, Object message, final IMLVBLiveRoomListener.SendRoomCustomMsgCallback callback);
     ...
     * @param callback
     */
    public abstract void sendC2CCustomMsg(String recUserId, String cmd, String message, final IMLVBLiveRoomListener.SendC2CCustomMsgCallback callback);
